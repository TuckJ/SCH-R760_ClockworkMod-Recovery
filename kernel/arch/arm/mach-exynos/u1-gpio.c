...
static struct gpio_init_data u1_init_gpios[] = {
	...
	{EXYNOS4210_GPE1(6),S3C_GPIO_INPUT,S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_DOWN,S5P_GPIO_DRVSTR_LV4},
#else
	...
	{EXYNOS4_GPL1(1),S3C_GPIO_INPUT,S3C_GPIO_SETPIN_ZERO,
              S3C_GPIO_PULL_DOWN,S5P_GPIO_DRVSTR_LV4},
#endif
...
#if defined(CONFIG_MACH_U1_NA_USCC)		 
	{EXYNOS4_GPY3(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO,
		 S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV4},
	{EXYNOS4_GPY3(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO,
		 S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV4},	 
#endif		 
...
#if defined(CONFIG_MACH_U1_NA_USCC)
	{EXYNOS4_GPY3(6),S3C_GPIO_INPUT,S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_DOWN,S5P_GPIO_DRVSTR_LV4},
	{EXYNOS4_GPY3(5),S3C_GPIO_INPUT,S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_DOWN,S5P_GPIO_DRVSTR_LV4},
	{EXYNOS4210_GPE2(3),S3C_GPIO_INPUT,S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_DOWN,S5P_GPIO_DRVSTR_LV4},
#endif
};
...
#if defined(CONFIG_TARGET_LOCALE_NA) && !defined(CONFIG_MACH_U1_NA_USCC)
...
#if defined(CONFIG_MACH_U1_NA_USCC)
	{ EXYNOS4_GPB(4),       S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},
	{ GPIO_WIMAX_IF_MODE1,S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	{ GPIO_WIMAX_IF_MODE0,S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	{ GPIO_WIMAX_CON2,S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},
	{ GPIO_CMC_SCL_18V,S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	{ GPIO_CMC_SDA_18V,S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
#else
